...
<aside
    class="text-[0.75em] font-sans font-normal leading-loose text-stone-600 dark:text-stone-400 <?php if (is_singular('post')): ?>border-t border-stone-400 dark:border-stone-500 mt-12 pt-2<?php else: ?>mt-4<?php endif; ?>">
